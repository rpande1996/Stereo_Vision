...
def SiftCompare(x):
    if x == 1:
        Image_1 = cv2.imread('../media/input/Cycle/im0.png')
        Image_2 = cv2.imread('../media/input/Cycle/im1.png')
    elif x == 2:
        Image_1 = cv2.imread('../media/input/Flowers/im0.png')
        Image_2 = cv2.imread('../media/input/Flowers/im1.png')
    elif x == 3:
        Image_1 = cv2.imread('../media/input/Umbrella/im0.png')
        Image_2 = cv2.imread('../media/input/Umbrella/im1.png')
    else:
        print("Invalid Selection")
        exit()
...
if x == 1:
    plt.savefig('../media/output/Cycle/Disparity Map - Heat.png')
elif x == 2:
    plt.savefig('../media/output/Flowers/Disparity Map - Heat.png')
elif x == 3:
    plt.savefig('../media/output/Umbrella/Disparity Map - Heat.png')
plt.show()

plt.imshow(dm, cmap='gray', interpolation='nearest')
plt.title("Disparity Map - Gray")
if x == 1:
    plt.savefig('../media/output/Cycle/Disparity Map - Gray.png')
elif x == 2:
    plt.savefig('../media/output/Flowers/Disparity Map - Gray.png')
elif x == 3:
    plt.savefig('../media/output/Umbrella/Disparity Map - Gray.png')
plt.show()

plt.imshow(depth, cmap='hot', interpolation='nearest')
plt.title("Depth  Map - Heat")
if x == 1:
    plt.savefig('../media/output/Cycle/Depth Map - Heat.png')
elif x == 2:
    plt.savefig('../media/output/Flowers/Depth Map - Heat.png')
elif x == 3:
    plt.savefig('../media/output/Umbrella/Depth Map - Heat.png')
plt.show()

plt.imshow(depth, cmap='gray', interpolation='nearest')
plt.title("Depth Map - Gray")
if x == 1:
    plt.savefig('../media/output/Cycle/Depth Map - Gray.png')
elif x == 2:
    plt.savefig('../media/output/Flowers/Depth Map - Gray.png')
elif x == 3:
    plt.savefig('../media/output/Umbrella/Depth Map - Gray.png')
plt.show()
...
if x == 1:
    cv2.imwrite("../media/output/Cycle/Epipolar 0.png", Im1_1)
elif x == 2:
    cv2.imwrite("../media/output/Flowers/Epipolar 0.png", Im1_1)
elif x == 3:
    cv2.imwrite("../media/output/Umbrella/Epipolar 0.png", Im1_1)

cv2.imshow("Epipolar 1", Im1_2)
if x == 1:
    cv2.imwrite("../media/output/Cycle/Epipolar 1.png", Im1_2)
elif x == 2:
    cv2.imwrite("../media/output/Flowers/Epipolar 1.png", Im1_2)
elif x ==3:
    cv2.imwrite("../media/output/Umbrella/Epipolar 1.png", Im1_2)

cv2.imshow("Combined Epipolar", both)
if x == 1:
    cv2.imwrite('../media/output/Cycle/Combined Epipolar.png', both)
elif x == 2:
    cv2.imwrite('../media/output/Flowers/Combined Epipolar.png', both)
elif x == 3:
    cv2.imwrite('../media/output/Umbrella/Combined Epipolar.png', both)
